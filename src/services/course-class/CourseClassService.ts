...
class CourseClassService {
  ...
  searchClasses = (params: any) => {
    return new Promise((resolve, reject) => {
      const key = params?.key;
      const limit = params?.limit;
      axios
        .get(`${import.meta.env.VITE_DOMAIN}/api/courseclasses/search`, {
          params: {
            key,
            limit,
          },
  ...
  getTeacherByClass = (id: string) => {
    return new Promise((resolve, reject) => {
      axios
        .get(`${import.meta.env.VITE_DOMAIN}/api/courseclasses/${id}/teacher`)
        .then((response) => resolve(response))
        .catch(function (error) {
          if (error.response) {
            // The request was made and the server responded with a status code
    ...
    return new Promise((resolve, reject) => {
      ...
      axios
        .post(
          ...
          }/api/courseclasses/${id}/addliststudent`,
          form
        )
        .then((response) => resolve(response))
        .catch(function (error) {
